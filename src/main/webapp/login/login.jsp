    ...
    //点击切换验证码
        $(function () {
            ...
            $("#captchaImage").click(function(){
                $("#captchaImage").prop('src',"${path}/code/getCode?"+new Date().getTime());
            });
                ...
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    <div class="form-top" style="width: 450px">
                        <div class="form-top-left">
                            ...
                            <p>Enter your username and password to log on:</p><h4>${requestScope.massage}</h4>
                        </div>
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="${pageContext.request.contextPath}/admin/loginadmin" method="post" class="login-form" id="loginForm">
                            <span id="msgDiv"></span>
                            <div class="form-group">
                                <label class="sr-only" for="form-username">Username</label>
                                 <%--required id 这个属性是表单验证的功能，有了他会让系统自动识别输入框input在它下面显示对应的错误--%>
